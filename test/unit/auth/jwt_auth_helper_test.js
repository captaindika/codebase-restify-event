...
const queryUser = require('../../../bin/modules/notification/repositories/queries/query_handler');
...
describe('Json Web Token', () => {
  ...
  describe('verifyToken', () => {
    ...
    it('should return error notification', async() => {
      ...
      sinon.stub(queryUser, 'checkUserById').resolves({err: new Error('error')});
      await jwtHelper.verifyToken(req, res, next);
      queryUser.checkUserById.restore();
      jwt.verify.restore();
    });
  });
});
